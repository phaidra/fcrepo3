...
import org.fcrepo.server.hooks.*;  // Hugh Barnard January 2015
...
public class ManagementModule
    ...
    public void postInitModule() throws ModuleInitializationException {
        ...
        /* Hugh Barnard January 2015 added m_hooks + module logic */
        
        m_hooks = (APIHooks) getServer().getModule("org.fcrepo.server.hooks.APIHooks");
        if (m_hooks == null) {
            throw new ModuleInitializationException("Can't get hooks module from Server.getModule", getRole());
        }
