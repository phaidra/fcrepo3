...
/* Hugh Barnard January 2015 replace with org.fcrepo refactoring */
...
public class APISOAPHooksImpl extends APIHooksImpl implements APIHooks 
{
	 ...
	 */
	public String runHook(String method, DOWriter w, Context context, String pid, Object[] params) throws APIHookException
	{
		String rval = null;
		...
		catch(Exception ex)
		{
			...
			throw new APIHookException("Error calling SOAP hook: "+ex.getMessage(), ex);
		}
